...
public class CrabPortion extends Ingredient_portion_parent implements IngredientPortion{
...
//			return this.ing_p;
//		}  
//		if(ing_p.getIngredient().equals(other.getIngredient())) {
...
//			IngredientPortion a = new CrabPortion(total_amount);
//			return a;
//
//
//		} 
